...
from ..internal.pjl_helper import (
    ...
    _get_name_of_upgrade,
    _get_size_of_upgrade,
    _get_type_and_value,
    _is_upgrade,
    get_pjl_commands,
)

TEST_DATA_UPGRADE_RAW = (
    b'\x40\x50\x4a\x4c\x20\x55\x50\x47\x52\x41\x44\x45\x20\x53\x49\x5a\x45\x3d\x31\x31\x32\x0d\x0a'
