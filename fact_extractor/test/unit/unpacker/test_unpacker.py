...
class TestUnpackerBase:
    ...
    def check_unpacker_selection(self, mime_type, plugin_name):
        unpacker = self.unpacker.base.get_unpacker(mime_type)
...
class TestUnpackerCore(TestUnpackerBase):
    def test_generic_carver_found(self):
        assert 'generic_carver' in self.unpacker.base.unpacking_plugins, 'generic carver plugin not found'
        assert 'generic/carver' in self.unpacker.base.plugin_by_mime, 'generic carver MIME type not found'
        plugin = self.unpacker.base.get_unpacker('generic/carver')
