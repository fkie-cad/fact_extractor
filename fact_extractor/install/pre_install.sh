...
sudo apt-get update
sudo apt-get -y install python-pip python3-pip python3-setuptools git apt-transport-https ca-certificates curl software-properties-common wget libmagic-dev
